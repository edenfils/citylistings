		...
		<div className="col-lg-6 col-md-6 col-xs-12 col-sm-12">
			<div className="tb_work_txt_wrapper">
				<div className="abt_txt_box heading_white_wrapper">
					...
					<p>
						Fusce ec tincidunt ipsumelit. vel orciarel gravida rpis nibh nec,
						tincidunt ip et sem elementum, mis nibh nec, tincidunt ipsum etiau
						nec tincidunt ipsumelit. vel orciarel gravida rpis. Quisque sitmi
