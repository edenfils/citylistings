					...
					<div className="project-inner project-head">
						<div className="homes">
							<a href="#" className="homes-img">
								<div className="homes-tag button alt featured">owner</div>
								<div className="home-tag-price">$ 2500,00</div>
								<div className="homes-tag button alt sale">rent</div>
							</a>
						</div>
						<div className="homes_img_wrapper">
							<img src="img/lp3.jpg" alt="home" className="img-responsive" />
						</div>
					</div>
			...
			<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 prs_upcom_slide_first">
				<div className="lp_cntnt">
					<div className="project-inner project-head">
						<div className="homes">
							<a href="#" className="homes-img">
								<div className="homes-tag button featured offer">offer</div>
								<div className="home-tag-price">$ 2900,00</div>
								<div className="homes-tag button sale" id="sale_second_tr">
									sell
								</div>
							</a>
						</div>
						<div className="homes_img_wrapper">
							<img src="img/lp2.jpg" alt="home" className="img-responsive" />
						</div>
					</div>
			...
			<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 prs_upcom_slide_first">
				<div className="lp_cntnt">
					<div className="project-inner project-head">
						...
						<div className="homes_img_wrapper">
							<img src="img/lp4.jpg" alt="home" className="img-responsive" />
						</div>
					</div>
			...
			<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 prs_upcom_slide_first">
				<div className="lp_cntnt">
					<div className="project-inner project-head">
						<div className="homes">
							<a href="#" className="homes-img">
								<div className="homes-tag button featured agent">agent</div>
								<div className="home-tag-price">$ 2700,00</div>
								<div className="homes-tag button alt sale">Rent</div>
							</a>
						</div>
						<div className="homes_img_wrapper">
							<img src="img/lp1.jpg" alt="home" className="img-responsive" />
						</div>
					</div>
					...
					<div className="project-inner project-head">
						<div className="homes">
							<a href="#" className="homes-img">
								<div className="homes-tag button featured offer">offer</div>
								<div className="home-tag-price">$ 2900,00</div>
								<div className="homes-tag button sale" id="sale_second_nd">
									sell
								</div>
							</a>
						</div>
			...
			<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 prs_upcom_slide_first">
				<div className="lp_cntnt">
					<div className="project-inner project-head">
						...
						<div className="homes_img_wrapper">
							<img src="img/lp5.jpg" alt="home" className="img-responsive" />
						</div>
					</div>
